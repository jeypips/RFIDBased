angular.module('app-module',['form-validator','ui.bootstrap','bootstrap-modal','bootstrap-growl','block-ui']).factory('app', function($compile,$timeout,$http,bootstrapModal,growl,bui,validate) {
	...
	function app() {
		...
		function students(scope){
			...
			$http({
				method: 'POST',
				url: 'handlers/daily-records/students.php',
				data: scope.filter
			}).then(function mySucces(response) {
			...
			$('#content').load('lists/daily-records.html', function() {
		...
		self.print_s = function(scope) {
			...
			$http({
			  method: 'POST',
			  url: 'handlers/daily-records/printStudents.php',
			  data: scope.filter
			}).then(function mySucces(response) {
				
				scope.datas = response.data;
				
				print_s(scope,response.data);
